...
from {{cookiecutter.project_slug}} import MyMicroservice
...
class ProjectTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        ms = MyMicroservice(service="ms", path=os.path.join(os.path.dirname(os.path.dirname(__file__)),
                                                            "{{cookiecutter.project_slug}}", "test_views.py"))
